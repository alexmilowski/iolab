...
<p:declare-step xmlns:p="http://www.w3.org/ns/xproc"
   ...
   <p:directory-list path="shakespeare/ns/" include-filter=".*xml$"/>
   <p:viewport match="c:file">
      <p:output port="out">
         <p:pipe step="insert" port="result"/>
      </p:output>
      <p:variable name="url" select="concat('http://www.ibiblio.org/xml/examples/shakespeare/ns/',/c:file/@name)"/>
      <p:load>
      ...
      <ml:insert-document name="insert">
         ...
         <p:with-option name="collections" select="'http://www.ibiblio.org/xml/examples/shakespeare/ns/'"/>
      </ml:insert-document>
   </p:viewport>
</p:declare-step>